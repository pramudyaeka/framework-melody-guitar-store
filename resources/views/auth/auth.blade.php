...
@section('content')
    <div class="flex">
        <img src="{{ asset('assets/images/melody-logo.png') }}" alt=""
            class="w-3/5 h-screen object-cover brightness-50">
                ...
                <div class="h-full px-12 py-8 flex flex-col justify-between items-center">
                    <form action="{{ route('login.action') }}" method="post" class="w-full flex flex-col items-start">
                        ...
                        <div class="w-full flex justify-between mt-4">
                            ...
                            <a href="#"
                                class=" text-sm text-end text-blue-900 hover:font-
                            medium">Forgot
                                password?</a>

                        </div>
                        <button type="submit"
                            class="w-full h-auto py-4 mt-16 text-white
                            font-medium bg-blue-800 rounded-md flex justify-center items-center
                            hover:bg-blue-700">
                            Masuk
                        </button>
                    </form>
